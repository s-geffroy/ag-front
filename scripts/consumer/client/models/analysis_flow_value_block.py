...
from ..models.analysis_flow_value_block_key import AnalysisFlowValueBlockKey
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.analysis_flow_value_row import AnalysisFlowValueRow





T = TypeVar("T", bound="AnalysisFlowValueBlock")



@_attrs_define
class AnalysisFlowValueBlock:
    """ 
        Attributes:
            title (str):
            description (str):
            key (AnalysisFlowValueBlockKey):
            ...
            rows (Union[Unset, list['AnalysisFlowValueRow']]):
     """
    ...
    rows: Union[Unset, list['AnalysisFlowValueRow']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        key = AnalysisFlowValueBlockKey(d.pop("key"))
        ...
        for rows_item_data in (_rows or []):
            rows_item = AnalysisFlowValueRow.from_dict(rows_item_data)
        ...
        analysis_flow_value_block.additional_properties = d
        return analysis_flow_value_block
