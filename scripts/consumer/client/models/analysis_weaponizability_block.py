...
from ..models.analysis_weaponizability_block_key import AnalysisWeaponizabilityBlockKey
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.analysis_weaponizability_row import AnalysisWeaponizabilityRow





T = TypeVar("T", bound="AnalysisWeaponizabilityBlock")



@_attrs_define
class AnalysisWeaponizabilityBlock:
    """ 
        Attributes:
            title (str):
            description (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        key = AnalysisWeaponizabilityBlockKey(d.pop("key"))
        ...
        for rows_item_data in (_rows or []):
            rows_item = AnalysisWeaponizabilityRow.from_dict(rows_item_data)
        ...
        analysis_weaponizability_block = cls(
            title=title,
            description=description,
            key=key,
            columns=columns,
        ...
        analysis_weaponizability_block.additional_properties = d
        return analysis_weaponizability_block
