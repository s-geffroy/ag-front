...
T = TypeVar("T", bound="SystemMemberOut")



@_attrs_define
class SystemMemberOut:
    """ 
        Attributes:
            chokepoint_id (str):
            canonical_name (Union[None, Unset, str]):
            member_role (Union[None, Unset, str]):
    ...
    member_role: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        member_role: Union[None, Unset, str]
        if isinstance(self.member_role, Unset):
            member_role = UNSET
        else:
        ...
        if member_role is not UNSET:
            field_dict["member_role"] = member_role
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_member_role(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        member_role = _parse_member_role(d.pop("member_role", UNSET))
        ...
        system_member_out.additional_properties = d
        return system_member_out
