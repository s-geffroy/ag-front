...
T = TypeVar("T", bound="RiskChokepointOut")



@_attrs_define
class RiskChokepointOut:
    """ A chokepoint matched by a given risk_type, carrying that risk's impact.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        risk_chokepoint_out.additional_properties = d
        return risk_chokepoint_out
