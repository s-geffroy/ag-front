...
from ..models.analysis_system_cascade_block_key import AnalysisSystemCascadeBlockKey
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.analysis_system_cascade_row import AnalysisSystemCascadeRow





T = TypeVar("T", bound="AnalysisSystemCascadeBlock")



@_attrs_define
class AnalysisSystemCascadeBlock:
    """ 
        Attributes:
            title (str):
            description (str):
            key (AnalysisSystemCascadeBlockKey):
            ...
            rows (Union[Unset, list['AnalysisSystemCascadeRow']]):
     """
    ...
    rows: Union[Unset, list['AnalysisSystemCascadeRow']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        key = AnalysisSystemCascadeBlockKey(d.pop("key"))
        ...
        for rows_item_data in (_rows or []):
            rows_item = AnalysisSystemCascadeRow.from_dict(rows_item_data)
        ...
        analysis_system_cascade_block = cls(
            title=title,
            description=description,
            key=key,
            columns=columns,
        ...
        analysis_system_cascade_block.additional_properties = d
        return analysis_system_cascade_block
