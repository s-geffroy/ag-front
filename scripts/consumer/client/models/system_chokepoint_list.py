...
T = TypeVar("T", bound="SystemChokepointList")



@_attrs_define
class SystemChokepointList:
    """ 
        Attributes:
            returned (int):
            total_count (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        system_chokepoint_list.additional_properties = d
        return system_chokepoint_list
