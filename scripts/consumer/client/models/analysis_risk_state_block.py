...
from ..models.analysis_risk_state_block_key import AnalysisRiskStateBlockKey
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.analysis_risk_state_row import AnalysisRiskStateRow





T = TypeVar("T", bound="AnalysisRiskStateBlock")



@_attrs_define
class AnalysisRiskStateBlock:
    """ 
        Attributes:
            title (str):
            description (str):
            key (AnalysisRiskStateBlockKey):
            columns (Union[Unset, list[str]]):
            generated_at (Union[None, Unset, datetime.datetime]):
            rows (Union[Unset, list['AnalysisRiskStateRow']]):
     """
    ...
    rows: Union[Unset, list['AnalysisRiskStateRow']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        key = AnalysisRiskStateBlockKey(d.pop("key"))
        ...
        for rows_item_data in (_rows or []):
            rows_item = AnalysisRiskStateRow.from_dict(rows_item_data)
        ...
        analysis_risk_state_block.additional_properties = d
        return analysis_risk_state_block
