...
T = TypeVar("T", bound="AnalysisPredictionConsensusRow")



@_attrs_define
class AnalysisPredictionConsensusRow:
    """ One `prediction_consensus` row (`analytics.prediction_consensus_result`).
        ...
        Attributes:
            ...
            attachment_rules (Union[None, Unset, list[str]]):
     """
    ...
    attachment_rules: Union[None, Unset, list[str]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        attachment_rules: Union[None, Unset, list[str]]
        if isinstance(self.attachment_rules, Unset):
            attachment_rules = UNSET
        elif isinstance(self.attachment_rules, list):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_attachment_rules(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                attachment_rules_type_0 = cast(list[str], data)

                return attachment_rules_type_0
            except: # noqa: E722
                pass
            return cast(Union[None, Unset, list[str]], data)

        attachment_rules = _parse_attachment_rules(d.pop("attachment_rules", UNSET))


        analysis_prediction_consensus_row = cls(
        ...
        analysis_prediction_consensus_row.additional_properties = d
        return analysis_prediction_consensus_row
