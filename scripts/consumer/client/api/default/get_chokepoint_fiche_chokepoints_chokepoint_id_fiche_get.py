...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/chokepoints/{chokepoint_id}/fiche".format(chokepoint_id=chokepoint_id,),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Get Chokepoint Fiche

     Consolidated Chokepoint Control Method fiche as JSON (ADR 0049). Derived/candidate; validated
    analytical readings only. There is intentionally NO global cross-chokepoint power ranking endpoint —
    leverage is grouped only within a leverage family for a single chokepoint.
