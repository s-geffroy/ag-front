---
title: 'Malacca : une dépendance énergétique sans vraie alternative'
date: 2026-07-15
summary: >-
  Premier chokepoint pétrolier mondial, le détroit de Malacca concentre les flux
  du Golfe vers l’Asie — et ses contournements ne remplacent pas sa capacité.
access: public
...
decision_implication: >-
  Une direction énergie ou supply chain exposée à l’Asie devrait traiter Malacca
  comme un point de passage sans substitut de capacité à court terme, pas comme
  une route interchangeable.
blind_spot: >-
  La capacité résiduelle réelle des alternatives (Lombok, Sonde) et le taux
  d’utilisation effectif du pipeline Chine-Myanmar ne sont pas documentés
  publiquement : l’affirmation « non substituable » est étayée mais bornée par
  cette lacune.
confidence: moyen
corrections: []
sources:
  - label: U.S. EIA — World Oil Transit Chokepoints (via Vortexa)
    type: institutionnel
  - label: MPA Singapore — statistiques portuaires annuelles
    type: institutionnel
  - label: ReCAAP ISC — rapport annuel piraterie (SOMS)
    type: institutionnel
  - label: Reuters / Global Energy Monitor — capacité du pipeline Chine-Myanmar
...
de le remplacer. Les détroits de la Sonde et de Lombok sont praticables — Lombok accueille
...
3. **Montée en charge des contournements et du pipeline** — tant que le pipeline plafonne vers
   2 %, le report reste marginal en volume.

> Diagnostic provisoire — chiffres candidats en attente de validation humaine. La capacité
> d’absorption exacte des alternatives n’existe pas en source primaire publique.

## Pour aller plus loin

- Le vocabulaire, Malacca en exemple : [un corridor n’est pas une route](/notes/un-corridor-nest-pas-une-route).
