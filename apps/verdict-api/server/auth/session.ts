...
// session id; all state lives server-side and is revoked on logout. Distinct cookie name from HDDE
// (SameSite=strict → no cross-subdomain sharing; double seeding is accepted in v1, see ADR 0041).
