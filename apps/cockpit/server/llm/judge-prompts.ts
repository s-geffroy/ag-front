...
Renvoie un objet JSON avec les clés : analysis (string), gate_verdicts[] (target_kind ∈ {rubric, munich}, target_id, label, verdict ∈ {pass, fail, uncertain}, justification, evidence_quote, confidence 0-1), do_not_conclude[] (string), injection_detected (bool), injection_evidence (string, vide si injection_detected = false).`;
}
