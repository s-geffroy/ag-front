...
> les sections marquées `[À SOURCER]` / `[À COMPLÉTER]` attendent des preuves recoupées (≥ 2 sources
> indépendantes) avant promotion. Aucune affirmation structurante n'est validée tant qu'elle n'est
> pas sourcée. Candidats-sources : `docs/evidence/mer-rouge-suez-assurance-candidates.md`.
