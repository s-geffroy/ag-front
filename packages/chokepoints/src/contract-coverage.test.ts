...
const SCHEMA_MAP: Record<string, z.ZodTypeAny> = {
  ...
  NewsClusterChokepoint: schemas.NewsClusterChokepoint,
  NewsClusterOut: schemas.NewsClusterOut,
  NewsFeedOut: schemas.NewsFeedOut,
  ...
  ActorControlList: schemas.ActorControlList,
  ActorList: schemas.ActorList,
  AlertList: schemas.AlertList,
  AnalysisClaimOut: schemas.AnalysisClaimOut,
  AnalysisControlConcentrationBlock: schemas.AnalysisControlConcentrationBlock,
  AnalysisControlConcentrationRow: schemas.AnalysisControlConcentrationRow,
  AnalysisCorroborationBlock: schemas.AnalysisCorroborationBlock,
  AnalysisCorroborationRow: schemas.AnalysisCorroborationRow,
  AnalysisCriticalityScoreBlock: schemas.AnalysisCriticalityScoreBlock,
  AnalysisCriticalityScoreRow: schemas.AnalysisCriticalityScoreRow,
  AnalysisEventPressureBlock: schemas.AnalysisEventPressureBlock,
  AnalysisEventPressureRow: schemas.AnalysisEventPressureRow,
  AnalysisEvidenceQualityBlock: schemas.AnalysisEvidenceQualityBlock,
  AnalysisEvidenceQualityRow: schemas.AnalysisEvidenceQualityRow,
  AnalysisExposedTradeLossBlock: schemas.AnalysisExposedTradeLossBlock,
  AnalysisExposedTradeLossRow: schemas.AnalysisExposedTradeLossRow,
  AnalysisFlowExposureBlock: schemas.AnalysisFlowExposureBlock,
  AnalysisFlowExposureRow: schemas.AnalysisFlowExposureRow,
  AnalysisFlowValueBlock: schemas.AnalysisFlowValueBlock,
  AnalysisFlowValueRow: schemas.AnalysisFlowValueRow,
  AnalysisNetworkCentralityBlock: schemas.AnalysisNetworkCentralityBlock,
  AnalysisNetworkCentralityRow: schemas.AnalysisNetworkCentralityRow,
  AnalysisPredictionConsensusBlock: schemas.AnalysisPredictionConsensusBlock,
  AnalysisPredictionConsensusRow: schemas.AnalysisPredictionConsensusRow,
  AnalysisRegimeAssessmentBlock: schemas.AnalysisRegimeAssessmentBlock,
  AnalysisRegimeAssessmentRow: schemas.AnalysisRegimeAssessmentRow,
  AnalysisRelationOut: schemas.AnalysisRelationOut,
  AnalysisRiskStateBlock: schemas.AnalysisRiskStateBlock,
  AnalysisRiskStateRow: schemas.AnalysisRiskStateRow,
  AnalysisSubstitutionScoreBlock: schemas.AnalysisSubstitutionScoreBlock,
  AnalysisSubstitutionScoreRow: schemas.AnalysisSubstitutionScoreRow,
  AnalysisSystemCascadeBlock: schemas.AnalysisSystemCascadeBlock,
  AnalysisSystemCascadeRow: schemas.AnalysisSystemCascadeRow,
  AnalysisWeaponizabilityBlock: schemas.AnalysisWeaponizabilityBlock,
  AnalysisWeaponizabilityRow: schemas.AnalysisWeaponizabilityRow,
  AnalyticalResultList: schemas.AnalyticalResultList,
  ChokepointAnalysisOut: schemas.ChokepointAnalysisOut,
  EngineRunList: schemas.EngineRunList,
  EpisodeList: schemas.EpisodeList,
  EventSignalList: schemas.EventSignalList,
  FlowChokepointList: schemas.FlowChokepointList,
  NewsClusterCountry: schemas.NewsClusterCountry,
  NewsTopicBreak: schemas.NewsTopicBreak,
  RelationList: schemas.RelationList,
